...
import styles from './EkycApprovalPrinceUat.module.scss';
import type { IEkycApprovalPrinceUatProps } from './IEkycApprovalPrinceUatProps';
...
export default class EkycApprovalPrinceUat extends React.Component<IEkycApprovalPrinceUatProps> {
  public render(): React.ReactElement<IEkycApprovalPrinceUatProps> {
    ...
    return (
      <section className={`${styles.ekycApprovalPrinceUat} ${hasTeamsContext ? styles.teams : ''}`}>
        <ParallaxProvider>
          <HashRouter>
