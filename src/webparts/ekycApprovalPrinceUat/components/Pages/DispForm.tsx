...
import { IEkycApprovalPrinceUatProps } from "../IEkycApprovalPrinceUatProps";
...
export const DispForm: React.FunctionComponent<IEkycApprovalPrinceUatProps> = (props: IEkycApprovalPrinceUatProps) => {
