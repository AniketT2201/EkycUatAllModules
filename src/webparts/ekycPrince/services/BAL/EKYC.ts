...
export interface IDashboardOps {
    getDashboardData(props: IEkycPrinceProps): Promise<IEKYC[]>;
  ...
  getDashboardItemById(listName: string ,id: number, props: IEkycPrinceProps): Promise<IEKYC>;
  insertDashboardData(item: IEKYC, props: IEkycPrinceProps): Promise<any>;
  updateDashboardData(id: number, item: IEKYC, props: IEkycPrinceProps): Promise<void>;
  preFillData(code: string, props: IEkycPrinceProps): Promise<{EmployeeName?: string; Department?: string}>;
...
export default function DashboardOps(): IDashboardOps {
    ...
    const getDashboardData = async ( props: IEkycPrinceProps): Promise<IEKYC[]> => {
    ...
    const getDashboardItemById = async (listName: string ,id: number, props: IEkycPrinceProps): Promise<IEKYC> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const preFillData = async (code: string, props: IEkycPrinceProps): Promise<{EmployeeName?: string; Department?: string}> => {
        try {
    ...
    const insertDashboardData = async (item: IEKYC, props: IEkycPrinceProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const updateDashboardData = async (id: number, item: IEKYC, props: IEkycPrinceProps): Promise<void> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
