...
import styles from './EkycPrince.module.scss';
import type { IEkycPrinceProps } from './IEkycPrinceProps';
...
export default class EkycPrince extends React.Component<IEkycPrinceProps> {
  public render(): React.ReactElement<IEkycPrinceProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.ekycPrince} ${hasTeamsContext ? styles.teams : ''}`}>
        <ParallaxProvider>
          <HashRouter>
