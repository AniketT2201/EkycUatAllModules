...
import { IEkycApprovalTruboreUatProps } from "../IEkycApprovalTruboreUatProps";
...
export const DispForm: React.FunctionComponent<IEkycApprovalTruboreUatProps> = (props: IEkycApprovalTruboreUatProps) => {
