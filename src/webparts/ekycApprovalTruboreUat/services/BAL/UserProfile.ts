...
export interface UserProfileOps {
    getLoggUserProfile(props: IEkycApprovalTruboreUatProps): Promise<IUserProfile>;
}

export default function LoggUserProfileOps() {
    const spCrudOps = SPCRUDOPS();
        const getLoggUserProfile = async (props: IEkycApprovalTruboreUatProps): Promise<IUserProfile> => {
