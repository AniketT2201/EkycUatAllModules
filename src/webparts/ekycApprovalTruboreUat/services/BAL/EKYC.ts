...
export interface IDashboardOps {
    getDashboardData(props: IEkycApprovalTruboreUatProps): Promise<IEKYC[]>;
  ...
  getDashboardItemById(listName: string ,id: number, props: IEkycApprovalTruboreUatProps): Promise<IEKYC>;
  insertDashboardData(item: IEKYC, props: IEkycApprovalTruboreUatProps): Promise<any>;
  updateDashboardData(id: number, item: IEKYC, props: IEkycApprovalTruboreUatProps): Promise<void>;
  preFillData(code: string, props: IEkycApprovalTruboreUatProps): Promise<{EmployeeName?: string; Department?: string}>;
...
export default function DashboardOps(): IDashboardOps {
    ...
    const getDashboardData = async ( props: IEkycApprovalTruboreUatProps): Promise<IEKYC[]> => {
    ...
    const getDashboardItemById = async (listName: string ,id: number, props: IEkycApprovalTruboreUatProps): Promise<IEKYC> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const preFillData = async (code: string, props: IEkycApprovalTruboreUatProps): Promise<{EmployeeName?: string; Department?: string}> => {
        try {
    ...
    const insertDashboardData = async (item: IEKYC, props: IEkycApprovalTruboreUatProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const updateDashboardData = async (id: number, item: IEKYC, props: IEkycApprovalTruboreUatProps): Promise<void> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
